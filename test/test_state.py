...
def test_state_publishers(sut):
    ...
    actual_publishers = {for pub in actual_state.publishers}
    expected_publishers = 
...
def test_state_subscribers(sut):
    actual_state = sut.ros2.launch
    actual_subscribers = {for sub in actual_state.subscribers}
...
def test_state_services(sut):
    actual_state = sut.ros2.launch
    actual_services = {for serv in actual_state.services}
    expected_services =
