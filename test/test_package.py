...
def test_package_location_ros2(sut):
    expected_paths = {'/ros_ws/install/pcl_conversions',
                      ...
                      '/ros_ws/install/rosidl_typesupport_connext_cpp',
                      '/ros_ws/install/nav2_common',
                      '/ros_ws/install/rmw_connext_cpp',
                      ...
                      '/ros_ws/install/rosidl_typesupport_connext_c',
                      '/ros_ws/install/rosidl_generator_py',
                      '/ros_ws/install/rmw_connext_shared_cpp',
                      ...
                      '/ros_ws/install/connext_cmake_module',
