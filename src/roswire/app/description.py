...
class AppDescription:
    ...
    @classmethod
    def load(
        cls, app: "App", filename: Optional[str] = None
    ) -> "AppDescription":
        if not filename:
        ...
        try:
            ...
            logger.exception(
                "failed to load description for app "
    ...
    def path(cls, app: "App") -> str:
        ...
        encoded_path = base64.b64encode(unencoded_path.encode("utf-8")).decode(
            "utf-8"
        )
