...
import functools
import struct
from typing import Any, BinaryIO, Callable, Dict, List, Optional, TypeVar
...
def string_reader(length: Optional[int] = None) -> Callable[[BinaryIO], str]:
...
def complex_array_reader(
    factory: Callable[[BinaryIO], T], length: Optional[int] = None
