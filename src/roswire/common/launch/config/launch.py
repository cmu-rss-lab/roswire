...
class LaunchConfig:
    ...
    def with_launch_prefixes(
        self, prefixes: Mapping[str, str]
    ) -> "LaunchConfig":
    ...
    def with_rosparam(self, name: str, value: Any) -> "LaunchConfig":
        # complex parameters
    ...
    def with_param(
        self, name: str, typ: str, value: Any, command: Optional[str] = None
    ) -> "LaunchConfig":
